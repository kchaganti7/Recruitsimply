        ...
        <div className='flex flex-grow items-center justify-center'>
          <div className="rounded-[24px] bg-white w-[400px] h-[400px]">
            <div className="pt-6 pl-10 pr-10 grid grid-cols-2 w-100 text-black text-center">
                <div className='border-solid border-2 border-white border-b-slate-300'><span className="font-bold"><Link href="/">Login</Link></span></div>
                <div className='border-solid border-2 border-white border-b-black'><span className="font-bold">Signup</span></div>
            </div>
            <div className="pt-7 pl-10 pr-10 text-black text-center">
